 ...
 * @return none
 */
typedef void (*connect_success_callback_fpt)(void);
typedef void (*disconnected_callback_fpt)(void);
...
#endif
    // jsq add 
    char                          *buf_host_name;                               // host name buffer 
    char                          *buf_client_id;                               // client id buffer
    char                          *buf_username;                                // username buffer
    char                          *buf_password;                                // password buffer
    char                          *buf_will_topic;                              // will topic buffer
    char                          *buf_will_message;                            // will message buffer

    connect_success_callback_fpt    connect_success_callback;                   // connect broker success callback
    disconnected_callback_fpt       disconnected_callback;                      // disconnected from broker callback
