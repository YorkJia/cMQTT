...
/**
 * @brief  MQTT client try to connect the broker
 *
 * @param [in] pclient  MQTT client point
 *
 * @retval    SUCCESS_RETURN : connect success.
 *            other : fail
 * @see None.
 */
...
#define CONFIG_MQTT_KEEPALIVE_INTERVAL          (5)
